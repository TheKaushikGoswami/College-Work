...
<head>
    ...
    <title>leaderboard Panel - Interschool</title>
    <!-- font awesome  -->
...
<body>
    ...
    <div class="container" id="container" data-aos="fade-down"
        ...
        <div class="form-container sign-up">
            <form>
                <h1 class="judges-panel"><span style="color: #FF6600;">LEADERBOARD</span> <span style="color: darkblue;">PANEL</span></h1>
                <h3>Choose one!</h3>
                <a href="./singing_leaderboard.php" class="btn">Singing</a>
                <a href="./declamation_leaderboard.php" class="btn">Declamation</a>
                <a href="./dancing_leaderboard.php" class="btn">Dancing</a>
        ...
        <div class="toggle-container">
            <div class="toggle">
                ...
                <div class="toggle-panel toggle-right">
                    ...
                    <p data-aos="zoom-in"
                        data-aos-duration="1100">Now Move for leaderboard Panel</p>
