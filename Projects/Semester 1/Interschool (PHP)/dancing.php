...
$query1 = "SELECT * FROM judges where name like '%Dance'";
...
<body>
    <div class="container">
        ...
        <h3 data-aos="fade-down" data-aos-duration="1000" class="title" style="margin-bottom: 15px;">Dancing Competition</h3>
        ...
        <form data-aos="zoom-out" data-aos-duration="1100" action="" method="post">
            ...
            <div class="section2-form">
                ...
                <label for="face_expression">Face Expression</label>
                <input type="number" id="face_expression" name="face_expression" required max="20">

                <label for="costume">Costume</label>
                <input type="number" id="costume" name="costume" required max="20">

                <label for="choreography">Choreography</label>
                <input type="number" id="choreography" name="choreography" required max="20">

                <label for="coordination">Coordination</label>
                <input type="number" id="coordination" name="coordination" required max="20">

                <input data-aos="zoom-in" data-aos-duration="1000" type="submit" name="dancing_submit" value="Submit">
            </div>
        </form>
